...
public class OsUtil {
	...
	public static void openExplorer(FileHandle handle) {
		if (!isWindows) {
	...
	public static void printPaths() {
		Gdx.app.debug("Local", Gdx.files.getLocalStoragePath());
		Gdx.app.debug("External", Gdx.files.getExternalStoragePath());
	}
}
